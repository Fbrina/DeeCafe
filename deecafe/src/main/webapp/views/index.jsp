...
<html lang="en">
  ...
  <head>
    ...
    <title>Dee Cafe -- Coffee and Eatery</title>
    ...
    <link rel="stylesheet" href="../views/assets/css/dee-cafe.css">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Dee Cafe adalah salah satu kafe yang menyediakan makanan, dari makanan ringan hingga berat serta minuman.</p>
                        <div class="row">
                            <div class="col-4">
    ...
    <section class="section" id="menu">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading">
                        <h6>Menu Best Seller</h6>
                        <h2>Pilihan menu best seller kami.</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <% for (int i=0; i < 3; i++) { %>
                        <div class="item">
                            <div class='card card1'>
                                <div class="price"><h6><%= d.get(i).getHarga() %>k</h6></div>
                                <div class='info'>
                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                          <li><a href='#tabs-1'><img src="../views/assets/images/tab-icon-01.png" alt="">Makanan</a></li>
                                          <li><a href='#tabs-2'><img src="../views/assets/images/tab-icon-02.png" alt="">Cemilan</a></a></li>
                                          <li><a href='#tabs-3'><img src="../views/assets/images/tab-icon-03.png" alt="">Minuman</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>Contact Us</h6>
                            <h2>Kamu dapat membuat Reservasi atau datang langsung ke Cafe kami.</h2>
                        </div>
                        <p>Tajur, Kec. Bogor Timur, Kota Bogor, Jawa Barat.</p>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                    ...
                    <div class="contact-form">
                        <form id="contact" action="" method="post">
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="number-guests" name="number-guests" id="number-guests">
                                    <option value="number-guests">Jumlah orang</option>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="time" id="time" type="text" placeholder="Waktu"></select>
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                              <fieldset>
